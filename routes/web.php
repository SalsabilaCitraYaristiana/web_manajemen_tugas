...
// ==================== RUTE PROTECTED (WAJIB LOGIN USER) ====================
Route::middleware('auth')->group(function () {
    ...
    // --- DIUBAH DISINI: URL DETAIL SEKARANG UNIK (TIDAK AKAN BENTROK KELIRU KE EDIT) ---
    ...
    // Fitur Tambahan (Notifikasi & Live Search API)
